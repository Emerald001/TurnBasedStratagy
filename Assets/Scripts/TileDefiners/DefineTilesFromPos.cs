...
//public class DefineTilesFromPos : TileDefiner {
...
//    public override List<Vector2Int> GetTiles(UnitManager Owner, Vector2Int gridPos, int speedValue, ref Dictionary<Vector2Int, Vector2Int> parentDic, Dictionary<Vector2Int, GameObject> grid) {
